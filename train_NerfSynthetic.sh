...
DATASET_ROOT="/path/to/datasets/nerf_synthetic"
OUTPUT_ROOT="./outputs/Nerf_Synthetic"
ENVIRONMENT_MAPS="/path/to/datasets/nerf_synthetic/Environment_Maps"
...
SCENE_PARAMS[mic,offset]="0.1"
SCENE_PARAMS[mic,geometry_threshold]="0.5"
