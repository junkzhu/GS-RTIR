...
def render_define_scene(scene_dict, render_spp, sensor):
    ...
    ensure_dir('/home/zjk/code/GS-RTIR/demos/outputs/motivation')
    ...
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/outputs/motivation', f'albedo' + ('.png')), albedo_bmp)
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/outputs/motivation', f'roughness' + ('.png')), roughness_bmp)
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/outputs/motivation', f'metallic' + ('.png')), metallic_bmp)
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/outputs/motivation', f'normal' + ('.png')), normal_bmp)
    ...
    if args.separate_direct_indirect:
        ...
        write_bitmap(join('/home/zjk/code/GS-RTIR/demos/outputs/motivation', f'direct_light' + ('.png')), direct_light_bmp)
        write_bitmap(join('/home/zjk/code/GS-RTIR/demos/outputs/motivation', f'indirect_light' + ('.png')), indirect_light_bmp)

    rgb_bmp = mi.Bitmap(img)
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/outputs/motivation', f'rgb' + ('.png')), rgb_bmp)

def render_image():
    render_spp = 32
    envmap_path = '/home/zjk/datasets/TensoIR/Environment_Maps/high_res_envmaps_2k/sunset.hdr'
        
    # Model paths
    ply_paths = [
        '/home/zjk/code/GS-RTIR/demos/scenes/R3DG/armadillo_r3dg.ply',
    ]
