...
def render_define_scene(scene_dict, render_spp, sensor):
    ...
    # Render scene
    buffer = mi.render(scene_dict, sensor=sensor, spp=render_spp)
    dr.eval(buffer)
