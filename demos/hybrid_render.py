...
def set_demo_scene_config(envmap_path = None):
    scene_config = {
        "type": "scene",
        ...
        "back": {
            "type": "obj",
            "filename": "./demos/scenes/meshes/cbox_back.obj",
            "bsdf": {
                "type": "ref",
                "id": "white"
            }
...
def set_hybrid_scene(envmap_path=None):
    gaussians = None
    ...
    with time_measure("Loading multiple gaussians"):
        ...
        # Create scene config
        scene_config = set_demo_scene_config(envmap_path)
        # Add gaussians to scene
        scene_config = add_gaussian_config(scene_config, all_gaussians_attributes)
    
    return scene_config, gaussians

def sensor_for_hybrid():
    sensor = make_sensor(
        cam_pos=(0, 0.0, 4.0),
        look_at=(0.0, 0.0, 0.0),
        up = (0, 1, 0),
...
def render_hybrid_demo():
    render_spp = 32
    envmap_path = '/home/zjk/datasets/bloem_train_track_cloudy_4k.exr'
        
    # Set hybrid scene
    scene_config, _ = set_hybrid_scene(envmap_path)
