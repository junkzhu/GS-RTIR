...
def render_define_scene(scene_dict, render_spp, sensor):
    ...
    ensure_dir('/home/zjk/code/GS-RTIR/demos/ablation_study/outputs')
    ...
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/ablation_study/outputs', f'albedo' + ('.png')), albedo_bmp)
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/ablation_study/outputs', f'roughness' + ('.png')), roughness_bmp)
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/ablation_study/outputs', f'metallic' + ('.png')), metallic_bmp)
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/ablation_study/outputs', f'normal' + ('.png')), normal_bmp)
    ...
    if args.separate_direct_indirect:
        ...
        write_bitmap(join('/home/zjk/code/GS-RTIR/demos/ablation_study/outputs', f'direct_light' + ('.png')), direct_light_bmp)
        write_bitmap(join('/home/zjk/code/GS-RTIR/demos/ablation_study/outputs', f'indirect_light' + ('.png')), indirect_light_bmp)

    rgb_bmp = mi.Bitmap(img)
    write_bitmap(join('/home/zjk/code/GS-RTIR/demos/ablation_study/outputs', f'rgb' + ('.png')), rgb_bmp)
