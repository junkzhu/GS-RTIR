...
CUDA_VISIBLE_DEVICES=0 python train.py --dataset_type Synthetic4Relight --dataset_name air_baloons --dataset_path /home/zjk/datasets/Synthetic4Relight/air_baloons --ply_path /home/zjk/datasets/Synthetic4Relight/3dgrt/air_baloons_refined.ply --selfocc_offset_max 0.5
