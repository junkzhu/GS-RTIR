...
# CUDA_VISIBLE_DEVICES=0 python train.py --dataset_type Synthetic4Relight --dataset_name jugs --dataset_path /path/to/datasets/Synthetic4Relight/jugs --ply_path /path/to/datasets/Synthetic4Relight/3dgrt/jugs_refined.ply --selfocc_offset_max 0.5 --geometry_threshold 0.3
# CUDA_VISIBLE_DEVICES=0 python render.py --dataset_type Synthetic4Relight --dataset_name jugs --dataset_path /path/to/datasets/Synthetic4Relight/jugs --ply_path /path/to/PTIR-Mitsuba/outputs/Synthetic4Relight/jugs/ply/iter_299.ply --render_spp 64 --envmap_init_path /path/to/PTIR-Mitsuba/outputs/Synthetic4Relight/jugs/envmap/optimized_sgs_0299.npy --relight --envmap_root /path/to/datasets/Synthetic4Relight/Environment_Maps --selfocc_offset_max 0.5 --geometry_threshold 0.3
# CUDA_VISIBLE_DEVICES=0 python metrics.py --dataset_type Synthetic4Relight --dataset_name jugs --dataset_path /path/to/datasets/Synthetic4Relight/jugs --envmap_root /path/to/datasets/Synthetic4Relight/Environment_Maps --relight
...
ENVIRONMENT_MAPS="/path/to/datasets/Synthetic4Relight/Environment_Maps"
...
SCENE_PARAMS[jugs,geometry_threshold]="0.5"

SCENE_PARAMS[chair,offset]="0.1"
SCENE_PARAMS[chair,geometry_threshold]="0.5"

SCENE_PARAMS[air_baloons,offset]="0.1"
SCENE_PARAMS[air_baloons,geometry_threshold]="0.5"
